...
function UiUxDesigning({ parent, lang, direction }: any) {
  const { theme, setTheme } = useTheme();

  const data = parent.UIUXDesign;
  return (
    <div dir={direction} className="bg-[#F2F6F5] dark:bg-[#061E2C]">
      <div className="">
        ...
        <div className="dark:bg-[#061E2C] bg-[#F2F6F5]">
          <div className=" grid w-full max-w-[1460px] grid-cols-12 mx-auto pt-[130px] ">
            <div className=" col-span-12 w-full lg:w-[792px] lg:h-[711px] lg:col-span-7 px-5 col-start-2 text-white">
              <Image
                src="/detailbg.png"
                width={792}
                height={711}
        ...
        <div className=" w-full max-w-[1460px] px-5 mx-auto  pb-[80px] ">
        ...
        <div className="lg:pb-[130px] pb-[50px]">
